...
class AboutSymbols < Neo::Koan
  ...
  # it may (depending on your ruby implementation) automatically be true,
  ...
  # that can't be freed until your program ends. You should only dynamically create symbols
  # (using string.to_sym) if you know you will:
